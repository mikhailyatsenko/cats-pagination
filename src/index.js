...
function createPagination(totalPages, page) {
  ...
  if (page > 1) {
    liTag += `<li class="page-item" onclick="createPagination(totalPages, ${page - 1});">Previous</li>`;
  }
  ...
  if (page < totalPages) { //show the next button if the page value is less than totalPage(20)
    liTag += `<li class="page-item" onclick="createPagination(totalPages, ${page + 1}); ">Next</li>`;
  }
